...
There is **no `references/` snapshot** — the skill links to live `.md` URLs (`https://anyrouter.dev/docs/<path>.md`) so the agent always works with current content. The auto-generated index is at [anyrouter.dev/docs.md](https://anyrouter.dev/docs.md).
...
(Get one at [anyrouter.dev/dashboard/keys](https://anyrouter.dev/dashboard/keys).)
...
If you only want the AnyRouter MCP server in another client (Claude Desktop, Cursor, Claude Code CLI, OpenCode), point it at `https://anyrouter.dev/api/v1/mcp`. Full per-client setup: [anyrouter.dev/docs/mcp.md](https://anyrouter.dev/docs/mcp.md).
...
- [anyrouter.dev/docs.md](https://anyrouter.dev/docs.md) — auto-generated index
- [anyrouter.dev/llms-full.txt](https://anyrouter.dev/llms-full.txt) — every doc concatenated
- [anyrouter.dev/llms.txt](https://anyrouter.dev/llms.txt) — short LLM index per `llmstxt.org`
- [anyrouter.dev/docs/index.json](https://anyrouter.dev/docs/index.json) — machine-readable manifest
